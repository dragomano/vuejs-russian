...
- **Подробности**
  ...
  В Vue 2 примеси были основным механизмом для создания многократно используемых фрагментов логики компонентов. Хотя примеси продолжают поддерживаться в Vue 3, [Композаблы](/guide/reusability/composables) теперь являются предпочтительным подходом для повторного использования кода между компонентами.
  :::
