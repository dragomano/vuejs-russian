...
Термин _композабл_ (_composable_) описывает общий шаблон использования в Vue. Это не отдельная функция Vue, это просто способ использования [Composition API](#composition-api) фреймворка.
