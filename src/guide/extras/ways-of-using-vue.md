...
Также существуют высокоуровневые [фреймворки Vue](/guide/quick-start#frameworks), построенные на основе этой парадигмы и предоставляющие встроенную поддержку SSR для разработки полноценных full-stack приложений.
...
Команда Vue поддерживает генератор статических сайтов [VitePress](https://vitepress.dev/), который используется для работы этого самого сайта, который вы сейчас читаете, и поддерживает оба варианта SSG! Кроме того, обязательно ознакомьтесь с другими [фреймворками Vue](/guide/quick-start#frameworks), которые обычно также поддерживают SSG.
