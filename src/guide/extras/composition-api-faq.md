...
Если вы намерены использовать исключительно Composition API (наряду с опциями, перечисленными выше), вы можете сократить свой производственный пакет на несколько КБ с помощью [флага времени компиляции](/api/compile-time-flags), который удаляет код, связанный с Options API, из Vue. Обратите внимание, что это также влияет на компоненты Vue в ваших зависимостях.
