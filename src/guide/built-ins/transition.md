...
Помимо этих двух компонентов, мы можем применять анимацию в Vue с помощью других техник, таких как переключение классов CSS или анимация, управляемая состоянием, с помощью привязки стилей. Эти дополнительные техники рассматриваются в главе [Техники анимации](/guide/extras/animation).
...
Для сравнения, такие свойства, как `height` или `margin`, запускают CSS-вёрстку, поэтому они гораздо дороже в анимации и должны использоваться с осторожностью. Мы можем проверить ресурсы вроде [CSS Triggers List](https://csstriggers.com/), чтобы узнать, какие свойства будут срабатывать при вёрстке, если мы их анимируем.
...
// вызывается по завершении перехода в режим ввода.
...
Вот демонстрация, использующая библиотеку [GreenSock](https://greensock.com/) для выполнения анимации. Разумеется, вы можете использовать любую другую библиотеку анимации, например [Anime.js](https://animejs.com/) или [Motion One](https://motion.dev/).
