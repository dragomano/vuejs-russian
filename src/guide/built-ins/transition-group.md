...
Затем в хуках JavaScript мы анимируем элемент с задержкой на основе атрибута данных. В этом примере для выполнения анимации используется [библиотека GSAP](https://gsap.com/):
