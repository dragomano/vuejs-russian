...
- Дизайн намеренно сделан низкоуровневым для гибкости. В будущем на его основе может быть построен компиляторный синтаксический сахар — либо в самом ядре, либо в решениях более высокого уровня, таких как [фреймворки на основе Vue](/guide/quick-start#frameworks).
