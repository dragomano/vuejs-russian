...
На самом деле, это очень близко к тому, как компилируются слоты с ограниченной областью действия, и как вы будете использовать такие слоты в своих [рендер-функциях](/guide/extras/render-function).
