...
```js [Утилиты Vue для тестирования]
...
> Чем больше ваши тесты напоминают то, как используется ваше программное обеспечение, тем больше уверенности они могут вам дать. - [Кент К. Доддс](https://x.com/kentcdodds/status/977018512689455106) – автор библиотеки тестирования
