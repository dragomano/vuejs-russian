...
В общем, модульные тесты выявляют проблемы с бизнес-логикой функции и ее логической корректностью.
...
Затем создайте в своем проекте файл, заканчивающийся `*.test.js`. Вы можете разместить все тестовые файлы в тестовом каталоге в корне проекта или в тестовых каталогах рядом с исходными файлами. Vitest будет автоматически искать их, используя соглашение об именовании.
