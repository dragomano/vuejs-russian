...
[Vite](https://vitejs.dev/) — это легкий и быстрый инструмент для сборки с первоклассной поддержкой Vue SFC. Ее создал Эван Ю, который также является автором Vue!
