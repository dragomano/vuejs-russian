...
### Пакет для NPM {#bundle-for-npm}

Если вы хотите создать и опубликовать свой плагин, чтобы им могли воспользоваться другие пользователи, смотрите раздел [Режим библиотеки](https://vite-docs.ru/guide/build.html#library-mode) в документации Vite.