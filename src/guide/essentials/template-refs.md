...
В версиях до 3.5, где `useTemplateRef()` не был введён, нам нужно объявить ссылку с именем, которое соответствует значению атрибута шаблонной ссылки. Ссылка также должна содержать массив значений:
