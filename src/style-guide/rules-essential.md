...
Это актуально только для [Однофайловых компонентов](/guide/scaling-up/sfc). Они _не_ требуют использования атрибута [`scoped`](/api/sfc-css-features#scoped-css). Для масштабирования можно использовать [CSS-модули](/api/sfc-css-features#css-modules), стратегию, основанную на классах, например [BEM](https://getbem.com/), или другую библиотеку/соглашение.
