...
Но они **никогда** не будут содержать глобального состояния (например, из хранилища [Pinia](https://pinia.vuejs.org/)).
...
**В именах параметров при объявлении всегда должен использоваться camelCase. При использовании внутри шаблонов в DOM параметр должен быть в шашлычном регистре. Шаблоны однофайловых компонентов и [JSX](/guide/extras/render-function#jsx-tsx) могут использовать параметры в kebab-case или camelCase. Регистр должен быть однообразным — если вы решили использовать параметр в camelCased, убедитесь, что вы не используете kebab-cased в своем приложении**.
...
// Вы можете использовать любой из вариантов, но мы не рекомендуем смешивать два разных стиля регистра
