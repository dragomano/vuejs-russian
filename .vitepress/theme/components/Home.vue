...
<template>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>Быстрый</h2>
      <p>
        Реактивный рендеринг, оптимизированный компилятором — ручная оптимизация почти не нужна.
      </p>
    </div>
    <div class="vt-box">
      <h2>Удобный</h2>
      <p>
        Основан на стандартных HTML, CSS и JavaScript. Предлагает интуитивный API и отличную документацию.
      </p>
    </div>
    <div class="vt-box">
      <h2>Мощный</h2>
      <p>
        Богатая экосистема с постепенным внедрением — от простой библиотеки до полноценного фреймворка.
      </p>
    </div>
  </section>
